...
class ResumePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white, // Light gray background for contrast
      body: SingleChildScrollView(
        child: Center(
          child: LayoutBuilder(
            builder: (context, constraints) {
              // Dynamically calculate width based on screen size
              double pageWidth = constraints.maxWidth < 800
                  ? constraints.maxWidth *
                      0.9 // For small screens, use 90% width
                  : 600; // Fixed width for larger screens (like desktops)
